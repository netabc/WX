...
export default{
  ...
  stopCompass:obj=>f(stopCompass,obj),
  //扫码
  ...
  getBLEDeviceServices:obj=>f(wx.getBLEDeviceServices,f(wx.getBLEDeviceCharacteristics,obj)),
  //IBeacon
  ...
  //震动
  vibrateLong:obj=>(wx.vibrateLong,obj),
  vibrateShort:obj=>(wx.vibrateShort,obj),
  //联系人
  addPhoneContact:obj=>(wx.addPhoneContact,obj),
  //NFC
